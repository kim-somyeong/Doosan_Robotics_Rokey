...
# User Imstructions
#
# In this problem you will implement SLAM in a 2 dimensional world.
# Please define a function, slam, which takes five parameters as input
# and returns the vector mu.
...
#
# neasurement_noise - The noise associated with measurement.
...
class matrix:
    ...
    # -------------------
    #
    # initialization - can be class with an initial matrix
    #
    ...
    # ------------------------
    #
    # defines elmement-wise matrix addition.
    ...
    # --------------------------
    #
    # defines elmement-wise matrix subtraction.
    # Both matrices must be of equal dimensions
    #
    ...
    # Both matrices must be fitting dimensions
    #
    ...
    # list1/list2 define a dequence of rows/colums that shall be taken
    ...
    # elements are being mapped.
    # Elements for rows and columns that are not listed in list1/list2
    ...
    # decomposiotion of matrix.
    # This code is based on http://adorio-research.rog/wordpress/?p=4560
...
# It moves on a straight line until is comes close to a wall at which point it turns
...
class robot:
    ...
    # -------
    # init:
    #   creates robot and initialized location to 0, 0
    #
    ...
    def make_landmarks(self, num_landmarks):
        ...
        for i in range(num_landmarks):
            self.landmarks.append([round(random.random() * self.world_size), round(random.random() * self.world_size)])
            self.num_landmarks = num_landmarks

    # -----------
    #
    # move: attempts to move robot by dx, dy.
    #       If outside world boundary, then the move does nothing
    #       and instead returns failure
    #
...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    muy = matrix(omegay).inverse() * matrix(xix)
