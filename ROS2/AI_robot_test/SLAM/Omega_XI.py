...
# initial robot position, move1, and move2.
# This function should compute the Omega and Xi matrices
...
class matrix:
    ...
    # ---------------
    # 
    # makes matrix of a certain size and sets each elements to zero
    #
    ...
    # Both matrices must be of equal dimension
    #   
    ...
    # Both matrices must be of fitting dimensions 
    # 
